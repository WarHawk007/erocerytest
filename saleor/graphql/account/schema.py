...
class AccountMutations(graphene.ObjectType):
    ...
    account_verify = AccountVerify.Field()
    account_forgot_verify = AccountForgotVerify.Field()
    account_forgot_password = AccountForgotPassword.Field()
    account_resend_sms = AccountResendSMS.Field()
