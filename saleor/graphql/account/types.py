...
class User(MetadataObjectType, CountableDjangoObjectType):
    ...
    phone = graphene.String(description="User Phone Number")
    phone_verified = graphene.Boolean(
        description="User phone verification Status", name="phone_verified")
    rider = graphene.Field(Rider, description="Rider Information")
    subshop = graphene.Field('saleor.graphql.shop.types.SubShop',
                             description="Admin Subshop Information")
    ...
    def resolve_permissions(root: models.User, _info, **_kwargs):
        ...
        elif root.shopid or root.riderid:
            permissions = list(root.get_group_permissions())
            permissions = get_permissions(permissions=permissions)
        else:
    ...
    @staticmethod
    def resolve_rider(root: models.User, info):
        return root.riderid

    @staticmethod
    def resolve_subshop(root: models.User, info):
        return root.shopid
