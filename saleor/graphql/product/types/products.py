...
class Product(CountableDjangoObjectType, MetadataObjectType):
    ...
    @staticmethod
    @one_of_permissions_required(["product.manage_products","product.view_product"])
...
class Category(CountableDjangoObjectType, MetadataObjectType):
    number = graphene.Int(description="Category No")
    ...
    @staticmethod
    def resolve_number(root: models.Category, info, **_kwargs):
        return root.pk
