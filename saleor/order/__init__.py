    ...
    CHOICES = [
        ...
        (
         ...
         (
            ASSIGNED,
            pgettext_lazy(
                "Status for an order with no items marked as assigned", "Assigned"
            ),
        ),
        (
            PARTIALLY_FULFILLED,
        ...
        (
            ACCEPTED,
            pgettext_lazy("Status for a permanently canceled order", "rider accepted"),
        ),
        (
            REJECTED,
            pgettext_lazy("Status for a permanently canceled order", "rider rejected"),
        ),
    ]
