...
ASGI_APPLICATION = 'saleor.asgi.application'
...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://saleor:saleor@localhost:5432/erocery", conn_max_age=600
    )
}
...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "fa^=&4++jai)m%e(6annod)g!d7xdb&9i%xvsie4nyn!_3shig")

MIDDLEWARE = [
    "django.contrib.sessions.middleware.SessionMiddleware",
    "django.middleware.security.SecurityMiddleware",
    # "saleor.graphql.middleware.CustomCorsMiddleware",
    # "saleor.graphql.middleware.open_access_middleware",
...
DEFAULT_COUNTRY = os.environ.get("DEFAULT_COUNTRY", "PK")
DEFAULT_CURRENCY = os.environ.get("DEFAULT_CURRENCY", "PKR")
...
ALLOWED_HOSTS = get_list(os.environ.get(
    "ALLOWED_HOSTS", "192.168.10.3,9d86f575.ngrok.io ,localhost, 127.0.0.1, 208.109.10.222, * ,0.0.0.0"))
